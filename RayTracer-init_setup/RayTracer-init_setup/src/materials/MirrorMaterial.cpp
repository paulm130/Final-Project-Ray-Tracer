...
Ray MirrorMaterial::sample_ray_and_update_radiance(Ray& ray, Intersection& intersection) {
     ...
     */
    vec3 reflection_dir = ray.dir-2.0f*(dot(ray.dir,normal))*normal;  // TODO: update reflection direction
     ...
     */
    vec3 W_specular = vec3(this->reflectance);  // TODO: throughput multiplier for current bounce
