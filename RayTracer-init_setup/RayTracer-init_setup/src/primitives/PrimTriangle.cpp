...
bool PrimTriangle::intersect(const Ray& ray, Intersection& out_hit) const {
     ...
     */
    //slide 57
    mat4 triangle = mat4(vertices[0].x,vertices[0].y,vertices[0].z,1,vertices[1].x,vertices[1].y,vertices[1].z, 1.0f,vertices[2].x,vertices[2].y,vertices[2].z, 1.0f,-1.0f*ray.dir.x ,-1.0f*ray.dir.y ,-1.0f*ray.dir.z, 0.0f);
